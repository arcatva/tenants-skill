...
- Images **must run as non-root** (`USER 65532`, the UID the platform runs them as; listen on 8080) — root images are rejected at deploy. See [references/docker.md](references/docker.md) + [references/app-templates.md](references/app-templates.md)
